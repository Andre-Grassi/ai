...
const std::map<int, std::pair<std::vector<int>, std::vector<int>>> kGridDimensionNeighborhood = {

    // Linha 1
    {0, {{1,5,6}, {HORIZONTAL_1, VERTICAL_1, DIAGONAL_11}}},
    {1, {{0,2,6,7}, {HORIZONTAL_1, VERTICAL_1, DIAGONAL_11, DIAGONAL_12}}},
    {2, {{1,3,6,7,8}, {HORIZONTAL_1, VERTICAL_1, DIAGONAL_12, DIAGONAL_13}}},
    {3, {{2,4,8,9}, {HORIZONTAL_1, VERTICAL_1, DIAGONAL_13, DIAGONAL_14}}},
    {4, {{3,9}, {HORIZONTAL_1, VERTICAL_1, DIAGONAL_14}}},

    // Linha 2
    {5, {{0,6,10,11}, {HORIZONTAL_2, VERTICAL_1, DIAGONAL_11, DIAGONAL_15}}},
    {6, {{0,1,2,5,7,10,11,12}, {HORIZONTAL_2, VERTICAL_1, VERTICAL_2, DIAGONAL_11, DIAGONAL_12, DIAGONAL_15, DIAGONAL_16}}},
    {7, {{1,2,3,6,8,11,12,13}, {HORIZONTAL_2, VERTICAL_2, VERTICAL_3, DIAGONAL_12, DIAGONAL_13, DIAGONAL_16, DIAGONAL_17}}},
    {8, {{2,3,4,7,9,12,13,14}, {HORIZONTAL_2, VERTICAL_3, VERTICAL_4, DIAGONAL_13, DIAGONAL_14, DIAGONAL_17, DIAGONAL_18}}},
    {9, {{3,4,8,13,14}, {HORIZONTAL_2, VERTICAL_4, DIAGONAL_14, DIAGONAL_18}}},

    // Linha 3
    {10, {{5,6,11,15,16}, {HORIZONTAL_3, VERTICAL_1, DIAGONAL_15, DIAGONAL_19}}},
    {11, {{5,6,7,10,12,15,16,17}, {HORIZONTAL_3, VERTICAL_2, VERTICAL_3, DIAGONAL_15, DIAGONAL_16, DIAGONAL_19, DIAGONAL_20}}},
    {12, {{6,7,8,11,13,16,17,18}, {HORIZONTAL_3, VERTICAL_3, VERTICAL_4, DIAGONAL_16, DIAGONAL_17, DIAGONAL_20, DIAGONAL_21}}},
    {13, {{7,8,9,12,14,17,18,19}, {HORIZONTAL_3, VERTICAL_4, VERTICAL_5, DIAGONAL_17, DIAGONAL_18, DIAGONAL_21, DIAGONAL_22}}},
    {14, {{8,9,13,18,19}, {HORIZONTAL_3, VERTICAL_5, DIAGONAL_18, DIAGONAL_22}}},

    // Linha 4
    {15, {{10,11,16,20,21}, {HORIZONTAL_4, VERTICAL_1, DIAGONAL_19, DIAGONAL_23}}},
    {16, {{10,11,12,15,17,20,21,22}, {HORIZONTAL_4, VERTICAL_2, VERTICAL_3, DIAGONAL_19, DIAGONAL_20, DIAGONAL_23, DIAGONAL_24}}},
    {17, {{11,12,13,16,18,21,22,23}, {HORIZONTAL_4, VERTICAL_3, VERTICAL_4, DIAGONAL_20, DIAGONAL_21, DIAGONAL_24, DIAGONAL_25}}},
    {18, {{12,13,14,17,19,22,23,24}, {HORIZONTAL_4, VERTICAL_4, VERTICAL_5, DIAGONAL_21, DIAGONAL_22, DIAGONAL_24, DIAGONAL_25}}},
    {19, {{13,14,18,23,24}, {HORIZONTAL_4, VERTICAL_5, DIAGONAL_22, DIAGONAL_25}}},

    // Linha 5
    {20, {{15,16,21}, {HORIZONTAL_5, VERTICAL_1, DIAGONAL_23}}},
    {21, {{15,16,17,20,22}, {HORIZONTAL_5, VERTICAL_2, VERTICAL_3, DIAGONAL_23, DIAGONAL_24}}},
    {22, {{16,17,18,21,23,26}, {HORIZONTAL_5, VERTICAL_3, VERTICAL_4, DIAGONAL_24, DIAGONAL_25}}},
    {23, {{17,18,19,22,24}, {HORIZONTAL_5, VERTICAL_4, VERTICAL_5, DIAGONAL_25}}},
    ...
    {32, {{26,27,28,30,34}, {VERTICAL_3, DIAGONAL_20, DIAGONAL_21, DIAGONAL_22}}},
...
struct Action {
   public:
    ...
    Action() : player_symbol(Symbol::kEmpty), cell_index_origin(-1), cell_index_destination(-1) {}

    Action(Symbol player_symbol, int cell_origin, int cell_destination)
        : player_symbol(player_symbol), cell_index_origin(cell_origin), cell_index_destination(cell_destination) {};
};
...
class AdugoGame : public Game<State, Action, Utility, Player> {
   public:
    ...
    bool IsAligned(int position1, int position2, int position3, std::vector<int>common_lines) const;
