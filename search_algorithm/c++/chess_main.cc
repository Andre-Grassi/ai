...
int main(){
    // Create a Chess Board problem -- Parametro: 1 ou 2 pra definir o tabuleiro inicial igual no enunciado
    ...
    std::shared_ptr<Node<chess_board::State, chess_board::Action>> solution =
